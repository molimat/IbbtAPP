...
export class OverlayApresentacao extends Component {
  state = {
    isVisible: true
  };
        ...
        >
          <View>
            ...
            <Text style={styles.text}>
              ...
              graça divina. Semelhante ao povo de Israel na caminhada rumo à
              terra prometida, somos peregrinos e prosseguimos em frente. Somos
              uma comunidade de fé que deseja cumprir fielmente a sua missão no
              mundo, disposta a superar os obstáculos e a deixar um vibrante
              testemunho acerca do evangelho de Jesus Cristo.{"\n"}
              {"   "} Nossas ênfases continuam sendo evangelização e missões,
              ensino da Palavra, adoração e testemunho, fortalecimento das
              famílias, ação solidária em favor dos carentes e comunhão
              fraterna. {"\n"}
              {"   "} A caminho dos 80 anos, somos renovados e revigorados no
              amor de Deus e no poder do seu Espírito. A Ele seja toda a glória.
              {"\n"}
              {"\n"}
              <B>Pastor Carlos Novaes </B> - Assumiu o ministério da Igreja
              Batista de Barão da Taquara em 1998. Casado com Jussara, pai de
              Luisa e Laura, o Pr. Novaes também é professor do Seminário
              Batista do Sul do Brasil e já ocupou várias funções na
              denominação.
              {"\n"}
              {"\n"}
